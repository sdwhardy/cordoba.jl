############################# acdc_tnep_convex_conv_strg_admm ###############
export acdc_tnep_convex_conv_strg_admm

""
function acdc_tnep_convex_conv_strg_admm(data::Dict{String,Any}, model_type::Type, solver; ref_extensions = [_PMACDC.add_ref_dcgrid!, _PMACDC.add_candidate_dcgrid!, _FP.add_candidate_storage!, _PM.ref_add_on_off_va_bounds!, _PM.ref_add_ne_branch!], setting = s, kwargs...)
    s = setting
    return _PM.run_model(data, model_type, solver, post_acdc_tnep_convex_conv_strg_admm; ref_extensions = [_PMACDC.add_ref_dcgrid!,_PMACDC.add_candidate_dcgrid!, _FP.add_candidate_storage!, _PM.ref_add_on_off_va_bounds!, _PM.ref_add_ne_branch!], setting = s, kwargs...)
end
...
""
function post_acdc_tnep_convex_conv_strg_admm(pm::_PM.AbstractPowerModel)
    ...
    vsp=[];vcp=[];vbp=[];vgp=[]
        ...
        objective_min_cost_acdc_convex_conv_strg_npv_admm(pm)
