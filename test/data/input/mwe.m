...
mpc.branchdc_ne = [
1	2	0.0	0.00	 0.00  20	    20	 20	 0.0 1;
1	2	0.0	0.00	 0.00  10	 		10	 10	 1.0 1;
];
...
mpc.convdc = [
										...
										2       2      1       1    4000000    0   	0     1.0   0.001  0.1       0 			 1 	0.08 		0 		0.001   0.09 		0  				220    1.1     0.9    100000      1     	 0     0        0       0      0.0050    -52.7     1.0079     0  		40000  -40000   40000    -40000;
];
...
mpc.convdc_ne = [
                2       2      1       1    0    0   	0     1.0   0.001  0.1       0 			 1 	0.08 		0 		0.001   0.09 		0  				220    1.1     0.9    100000      1     	 0     0        0       0      0.0050    -52.7     1.0079     0  		0  -0   0    -0   0;
];
