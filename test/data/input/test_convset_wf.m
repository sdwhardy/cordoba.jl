...
%% system MVA base
mpc.baseMVA = 100;
%%refer to Matpower 6.0 Users Manual for description of fields
%%Buses type 3= swing, type2=PV
%% bus data
...
mpc.branch = [
								1    2   0.004   0.04   0.00   0  		0  		0  		0  		0  			0 		-60  		60;
];

%% Candidate AC connections
...
mpc.ne_branch = [
										1     2  0.004  0.04  0.00    0  			0  			0  		 0    0   		0 			-60 	  60		100			100000;
];

%%-----  OPF Data  -----%%
%% Cost of generators here
%% generator cost data
...
%% Candidate Branches here - refer to MATACDC 1.0 Users Manual for description of fields
 ...
 mpc.convdc = [
 										1       1     	 2       3   4000    0   	0     	1.0     0.01 0.01       0 		 1 	0.01 	 1 			0.001   0.09 		0  				220    1.1     0.9    100000      1     1.103  0.887   1.885    1.885     0.0050  -52.7     	1.0079    0  		3041  -3041   3041    -3041  19.25;
 										2       2      	 3       2   4000    0   	0    	  1.0   	0.01 0.01       0 		 1 	0.01 	 1 			0.001   0.09 		0  				220    1.1     0.9    100000      1     1.103  0.887   1.885    1.885     0.0050  -52.7  	    1.0079    0  		3057  -3057   3057    -3057  19.25;
 								 ];
 ...
 %column_names%   busdc_i busac_i type_dc type_ac P_g   Q_g  islcc  Vtar    rtf   xtf  transformer tm   bf 	filter    rc     xc  reactor   basekVac Vmmax   Vmmin   Imax    status   LossA LossB  LossCrec LossCinv  droop     Pdcset    Vdcset  dVdcset Pacmax Pacmin Qacmax Qacmin cost
 mpc.convdc_ne = [
 										3       2        3       2    4000   0   	0     1.0    0.01   0.01       1 		  1 	0.08 	1 		0.001   0.09 		0  				220    1.1     0.9   100000      1     	 0     0        0       0      0.0050    -52.7     1.0079     	0  		0  		0   		0    	0  10000000;
 ];
