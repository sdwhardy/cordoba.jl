export cordoba_mp_acdc_opf

""
function cordoba_mp_acdc_opf(data::Dict{String,Any}, model_type::Type, solver; ref_extensions = [_PMACDC.add_ref_dcgrid!, _PM.ref_add_on_off_va_bounds!], setting = s, kwargs...)
    s = setting
    return _PM.run_model(data, model_type, solver, post_cordoba_mp_acdc_opf; ref_extensions = [_PMACDC.add_ref_dcgrid!, _PM.ref_add_on_off_va_bounds!], setting = s, kwargs...)
end
...
""
function post_cordoba_mp_acdc_opf(pm::_PM.AbstractPowerModel)
