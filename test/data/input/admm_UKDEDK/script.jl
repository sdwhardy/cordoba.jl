    ...
    "owpp_mva"=>[10000],#mva of wf in MVA
    "conv_lim"=>2000,#Max Converter size in MVA
    "candidate_ics_ac"=>[6/5,1,4/5,3/5,2/5,1/5],#AC Candidate Cable sizes (fraction of full MVA)
    "candidate_ics_dc"=>[1/5],#DC Candidate Cable sizes (fraction of full MVA)
    ...
    result_mip = _CBD.cordoba_acdc_wf_strg_admm(mn_data, _PM.DCPPowerModel, gurobi, multinetwork=true; setting = s)#Solve problem
    ...
    result_mip = _CBD.cordoba_acdc_wf_strg_admm(mn_data, _PM.DCPPowerModel, gurobi, multinetwork=true; setting = s)
