...
"corridor_limit" => true,
"onshore_grid"=>true)
#s["map_gen_types"]["countries"]["BLNK"][]
#[println(result_mip["result_mip"]["solution"]["nw"][string(k)]["gen"]["275"]) for k=1:1:32]
######################### Nodal market #########################
s["home_market"]=[]
@time result_mip=_CBD.social_welfare(s)
FileIO.save("C:\\Users\\shardy\\Documents\\julia\\times_series_input_large_files\\UK_BE_DE_DK\\nodal_market_k6_VOLL5000_wonshore4NL.jld2",result_mip)
######################### Zonal market #########################
