...
#=s = Dict(
    "rt_ex"=>pwd()*"\\test\\data\\input\\Yuso\\",#folder path if directly
    ...
    "res_years"=>["2015"],#Options: ["2012","2013","2014","2015","2016"]//#best for maintaining mean/max is k=6 2014, 2015
    ...
    EI_wind=DataFrames.DataFrame(XLSX.readtable(pwd()*"\\test\\data\\input\\Yuso\\Belgium_EI_2015\\Belgium_EI_2015\\results\\P.xlsx", "P")...)
