...
##################### Input parameters #################################
rt_ex=pwd()*"\\test\\data\\input\\UK_BE_DK_NOwf\\"#folder path
argz = Dict(
...
result_mip=FileIO.load("C:\\Users\\shardy\\Documents\\julia\\times_series_input_large_files\\chandra\\result_ukbedkNOwf2000_k5.jld2")
...
println(-1*benefits_y1/24)
println(-1*benefits_y2/12)
println(-1*benefits_y3/12)