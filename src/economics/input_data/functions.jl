...
function get_Cost_Data()
    ...
    #ks.ldc=1.775# changed from 0.32 on 3/12/21 to reflect cost in North sea annex
    ...
    #ks.lac=1.905# changed from 0.32 on 3/12/21 to reflect cost in North sea annex
...
function get_220kV_cables()#[kv, mm, mOhms/km, picoF/km, Amps, kE/km, mH/km]
    cbls220=[[220.0, 400.0, 40.1, 122.0, 590.0, 496.48, 0.457], [220.0, 500.0, 49.0, 140.0, 655.0, 597.4, 0.43], [220.0, 630.0, 39.1, 160.0, 715.0, 638.0, 0.41], [220.0, 800.0, 32.3, 170.0, 775.0, 783.0, 0.4], [220.0, 1000.0, 27.3, 190.0, 825.0, 812.0, 0.38]]
...
#**
#DC resistance from NKT cable High Voltage Cable Systems Cables and Accessories up to 550 kV
##0.0176 0.0151 0.0129 0.0113 0.0101 0.0090
#Corrected to 90 degrees using R=Rref(1+alpha(T-Tref))
#alpha copper: 0.00393/C
function get_150kV_cables()
    cbls150=[[150, 500, 46.7, 0.7, 1072, 277.3, 0.7], [150, 630, 36.1, 0.7, 1246, 289.9, 0.7], [150, 800, 28.2, 0.7, 1438, 306.3, 0.7], [150, 1000, 22.4, 0.7, 1644, 325.7, 0.7], [150, 1200, 19.3, 0.7, 1791, 345, 0.7], [150, 1400, 16.4, 0.7, 1962, 364.3, 0.7], [150, 1500, 15.4, 0.7, 2042.5, 374, 0.7], [150, 1600, 14.4, 0.7, 2123, 393.2, 0.7], [150, 1800, 12.9, 0.7, 2265, 431.5, 0.7], [150, 2000, 11.5, 0.7, 2407, 460, 0.7], [150, 2200, 10.3, 0.7, 2540, 488.5, 0.7], [150, 2400, 9.6, 0.7, 2678, 517, 0.7], [150, 2500, 9.2, 0.7, 2746, 531.3, 0.7], [150, 2600, 8.7, 0.7, 2814, 545.5, 0.7], [150, 2800, 7.8, 0.7, 2937, 574, 0.7], [150, 3000, 6.9, 0.7, 3066, 602.5, 0.7]]
    return cbls150
end
