...
candidate_ics=[1,4/5,3/5,1/2]#,1/2]#[[ic=1000,1200,1600,2000],[owpp]]#
...
wnd_energy=0
wnd_profit=0
for (i,n) in uk2dkwind["solution"]["nw"]
    wnd_energy=wnd_energy+n["gen"]["2"]["pg"]*(pwr)
    wnd_profit=wnd_profit+n["gen"]["2"]["pg"]*(pwr)*uk2dkwind_dta["nw"][i]["gen"]["1"]["cost"][1]*e2me
