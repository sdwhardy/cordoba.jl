    ...
    ##################### Input parameters #################################
    rt_ex=pwd()*"\\test\\data\\input\\admm_UKBEDEDK\\"#folder path
    argz = Dict(
    "scenario_planning_horizon"=>30,
    "scenario_names"=>["EU18","ST19","DG20"],#Options: ["EU17","EU18","EU19","EU20","ST17","ST18","ST19","ST20","DG17","DG18","DG19","DG20"]
    ...
    "yearly_investment"=>1000000)#4.932000160217285
