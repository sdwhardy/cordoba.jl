...
"k"=>100,#number of representative days modelled (24 hours per day)//Must add clustered time series for each k Available: 2, 5, 10, 50, 100
...
result_mip = @time _CBD.admm_4_AjAwAgAuAo_main(mn_data, gurobi, s);#Solve problem
