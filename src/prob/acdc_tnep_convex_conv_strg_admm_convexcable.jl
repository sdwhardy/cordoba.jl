############################# acdc_tnep_convex_conv_strg_admm_convexcable ###############
export acdc_tnep_convex_conv_strg_admm_convexcable

""
function acdc_tnep_convex_conv_strg_admm_convexcable(data::Dict{String,Any}, model_type::Type, solver; ref_extensions = [_PMACDC.add_ref_dcgrid!, _PMACDC.add_candidate_dcgrid!, _FP.add_candidate_storage!, _PM.ref_add_on_off_va_bounds!, _PM.ref_add_ne_branch!], setting = s, kwargs...)
    s = setting
    return _PM.run_model(data, model_type, solver, post_acdc_tnep_convex_conv_strg_admm_convexcable; ref_extensions = [_PMACDC.add_ref_dcgrid!,_PMACDC.add_candidate_dcgrid!, _FP.add_candidate_storage!, _PM.ref_add_on_off_va_bounds!, _PM.ref_add_ne_branch!], setting = s, kwargs...)
end
...
""
function post_acdc_tnep_convex_conv_strg_admm_convexcable(pm::_PM.AbstractPowerModel)
    ...
    vdp=[];vsp=[];vcp=[];vbp=[];vgp=[]
        ...
        objective_min_cost_acdc_convex_conv_strg_npv_admm_convexcable(pm)
